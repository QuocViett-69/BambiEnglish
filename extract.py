...
with open('extract_out.txt', 'w', encoding='utf-8') as f:
    ...
    get_text('https://thieunhi.edu.vn/Doi-ngu-giao-vien-20.html')
    get_text('https://thieunhi.edu.vn/CSVC-21.html')
    get_text('https://thieunhi.edu.vn/thong-tin/Tuyen-dung-4')
