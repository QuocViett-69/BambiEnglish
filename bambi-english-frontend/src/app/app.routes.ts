...
export const routes: Routes = [
  ...
  { path: 'giao-vien',      component: TeachersComponent,      title: 'Đội ngũ giáo viên – Bambi English' },
  { path: 'tuyen-dung',     component: RecruitmentComponent,   title: 'Tuyển dụng – Bambi English' },
